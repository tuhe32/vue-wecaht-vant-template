<template>
    <section class="container home">
        ...
        <div class="home_box mt7" v-for="(templateBlock,tIndex) in templateBlockList" :key="tIndex">
            <div class="tit">
                <span @click="gotoBlockBookList(templateBlock.id,templateBlock.title)">更多 <van-icon
                        name="arrow"/></span>
                <h3>{{templateBlock.title}}</h3>
            </div>
            <div class="book_list">
                <div class="bookItem" v-for="(book,oIndex) in templateBlock.bookList" :key="oIndex"
                     @click="gotoBlockBookDetaila(book)">
                    <div class="list_l">
...
<style scoped>
    ...
    .home_category::-webkit-scrollbar {
        height: 0 !important
    }
